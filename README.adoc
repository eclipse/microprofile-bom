...
image:https://badges.gitter.im/eclipse/microprofile-bom.svg[link="https://gitter.im/eclipse/microprofile-bom?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge"]
<project ...>
...
    <dependencies>
        <dependency>
